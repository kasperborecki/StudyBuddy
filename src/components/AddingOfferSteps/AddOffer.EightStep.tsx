...
const AddOfferEighthStep = () => {
  ...
  const handleTextAreaChange = (event: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    setDescription((prevDescription) => {
      // Użyj poprzedniego stanu, aby uniknąć problemów z asynchronicznością
  ...
  return (
    <div className='w-[80%]'>
      ...
      <p
        ...
        Dodaj <p className='text-[#D687F3] px-2'>Opis Oferty</p>Min 200 znaków:
      </p>
      <div>
        <div className='mb-8'>
          <div className=' w-full h-[250px] relative'>
            ...
            />
            <p
              className={`absolute bottom-2 right-4 ${isDarkMode ? 'text-white' : 'text-black'} countText`}>
